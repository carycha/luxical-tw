...
uv run luxical_hf_wrapper.py export --checkpoint ~/Downloads/luxical_one_rc4.npz --output-dir /tmp/luxical_tw-one

# Verify the export runs just like the native Luxical codepath.
uv run luxical_hf_wrapper.py verify --checkpoint ~/Downloads/luxical_one_rc4.npz --export-dir /tmp/luxical_tw-one
```
"""
...
from luxical_tw.embedder import Embedder, _pack_int_dict, _unpack_int_dict

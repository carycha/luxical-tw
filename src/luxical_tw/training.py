        ...
        try:
            ...
            while yielded_count < num_batches:
                ...
                for [text_batch, emb_batch] in shuffled_iter:
                    ...
                    # Pull out and match the ids IF THEY EXIST.
                    if "id" in text_batch.schema.names and "document_id" in emb_batch.schema.names:
                        assert text_batch["id"] == emb_batch["document_id"]
                    elif "id" in text_batch.schema.names or "document_id" in emb_batch.schema.names:
                        logger.warning("One dataset has IDs and the other doesn't. Skipping ID alignment check.")
